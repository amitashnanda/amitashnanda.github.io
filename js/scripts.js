...
(function ($) {
    ...
    jQuery(document).ready(function () {
       ...
       /* Mobile Navigation Hide or Collapse on Click */
        ...
        $(".typing").typed({
            strings: ["A Robotics Software Developer", "An IoT Developer", "An Electronics Hobbyist", " AI/ML Enthusiast", "I Love Technology"],    /* You can change the home section typing text from
